...
const Footer = () => {
  ...
  const defaultClassName = "p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900 mt-16"
  const fixedBottomClassName = "fixed w-full z-20 bottom-0 left-0"
  if (router.pathname.substr(0,10) === '/dashboard') {
    return <div></div>
  }
